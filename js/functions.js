...
function sortearCor() {
    var indexCorSorteada = corSorteada = Math.floor(Math.random() * engine.cores.length);
...
function aplicarCorNaCaixa(nomeDaCor) {
    ...
    caixaDasCores.style.backgroundColor = 'green';
...
if(Window.SpeechRecognition || window.webkitSpeechRecognition) {
    ...
    gravador.onresult = function(event){
        ...
        if(trancricaoAudio === respostaCorreta){
